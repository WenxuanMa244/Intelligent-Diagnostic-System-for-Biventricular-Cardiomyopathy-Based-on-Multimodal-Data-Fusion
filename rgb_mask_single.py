...
def main():
    # 1. 加载图像
    image_path = r"C:\Users\32572\Desktop\dataset\train_label_1\overlay_slice_0003.png"
    ...
    print(f"自动检测的紫色范围: lower={lower_purple}, upper={upper_purple}")
    ...
    # 9. 保存填充后的掩膜
    mask_output_path = r"C:\Users\32572\Desktop\mask_output.png"  # 掩膜保存路径
    cv2.imwrite(mask_output_path, filled_mask)
    print(f"填充后的最大连通区域掩膜已保存到：{mask_output_path}")
